...
**Goal:** Criar o scaffold navegavel do frontend em Next.js 15.5.23 com login mockado, home vazia, Tailwind CSS 3, Zod, Zustand e Axios, sem testes automatizados no frontend neste ciclo.
...
- Fluxo inicial: `/` redireciona para `/login`; login mockado navega para `/home`; `/home` fica vazia.
...
### Task 4: Login Mockado E Home Vazia

**Files:**
- Create: `frontend/app/(auth)/login/page.tsx`
- Create: `frontend/app/(dashboard)/home/page.tsx`
- Create: `frontend/src/features/auth/login-form.tsx`
- Create: `frontend/src/routes/routes.ts`
- Modify: `frontend/app/page.tsx`

**Interfaces:**
- Produces: rota `/login`, rota `/home`, redirecionamento `/` para `/login`.

- [ ] Criar formulario de login mockado usando `loginFormSchema`.
- [ ] Ao submeter dados validos, chamar `useSessionStore().simulateLogin` e navegar para `/home`.
- [ ] Criar `/home` sem conteudo funcional.
- [ ] Validar com `npm run lint` e `npm run build`.

## Self-Review

- Spec coverage: o plano cobre remocao de testes do front, Axios base, convencao de pastas, Zod, Zustand, Tailwind, login mockado, home vazia e verificacao por lint/build.
